...
<template>
  <main class="group space-y-5">
    ...
    >
      ...
      <aside class="flex justify-between px-4 relative z-10">
        <div class="flex flex-col gap-2 text-white text-sm">
          <p
            class="bg-[#98d8ca]  p-2 rounded-full size-15 flex items-center justify-center"
          >
            SALE
          </p>
          <p
        ...
        <div class="flex flex-col gap-3 translate-y-6 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
           <Icon icon="solar:heart-outline" class="cursor-pointer bg-white text-[#777] size-10 p-2" /> 
           <Icon icon="ph:shuffle-light" width="24" height="24" class="cursor-pointer bg-white text-[#777] size-10 p-2" /> 
            <Icon icon="tdesign:search" width="24" height="24" class="cursor-pointer bg-white text-[#777] size-10 p-2"/>
    ...
    <div class="my-4 flex flex-col gap-4 text-[#333333]">
      ...
      <button
        class="text-[#D3122A] absolute cursor-pointer translate-y-6 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-600"
      >
        + Add to cart
      </button>
